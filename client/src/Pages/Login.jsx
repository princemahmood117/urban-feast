...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-306px)] ">
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl mt-16 md:mt-24 lg:mt-24">
            ...
            <div className="mt-6">
              <div>
                <button
                  disabled={loading}
                  type="submit"
                  className="bg-gray-800 w-full rounded-md py-3 text-white hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50 duration-300 transform"
                >
                  {loading ? (
                    <ImSpinner7 className="animate-spin m-auto text-xl" />
                  ) : (
                    "Login"
                  )}
                </button>

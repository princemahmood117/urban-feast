...
const Register = () => {
  ...
  const handleCreateUser = async (e) => {
    ...
    try {
      ...
      // const {data} = await axios.post(`${import.meta.env.VITE_URL}/jwt`, {email: result?.user?.email},{withCredentials:true})
      // console.log(data);
  ...
  if(user || loading) return <div className="flex justify-center items-center mt-6">
    ...
    return (
      <div className='flex justify-center items-center min-h-[calc(100vh-306px)]'>
        <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl mt-10 md:mt-20 lg:mt-24'>
          ...
          <div className='hidden bg-cover bg-center lg:block lg:w-1/2 mt-20'>
